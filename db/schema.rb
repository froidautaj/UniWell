...
ActiveRecord::Schema[7.1].define(version: 2024_07_02_194645) do
  ...
  create_table "posts", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.bigint "accepted_comment_id"
    t.integer "total_upvotes", default: 0
    t.integer "total_downvotes", default: 0
    t.integer "total_comments", default: 0
    t.boolean "notify_by_email", default: false, null: false
    t.index ["accepted_comment_id"], name: "index_posts_on_accepted_comment_id"
  ...
  add_foreign_key "posts", "comments", column: "accepted_comment_id"
